...
export type {ProductsPageSchema} from './model/types/productsPageSchema.ts';
...
export {productsPageReducer, productsPageActions} from './model/slice/productsPageSlice.ts';
